...
from test_framework.test_framework import BitcoinRandomTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitcoinRandomTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoinrandom has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoinrandomd has not been built with zmq enabled.")
