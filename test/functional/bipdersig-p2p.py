...
class BIP66Test(BitcoinRandomTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinrandomd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinrandomd produces more specific reject
            # reasons.
