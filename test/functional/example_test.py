...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinRandomTestFramework
    pass

class ExampleTest(BitcoinRandomTestFramework):
    # Each functional test is a subclass of the BitcoinRandomTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinRandomTestFramework class so other tests can use it."""
