...
#ifndef BITCOINRANDOM_TEST_SCRIPTNUM10_H
#define BITCOINRANDOM_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinRandom Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRANDOM_TEST_BIGNUM_H
