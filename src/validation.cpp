...
#if defined(NDEBUG)
#error "BitcoinRandom cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "BitcoinRandom Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight > FORK_BLOCK) {
        ...
        halvings += (nHeight - FORK_BLOCK) / consensusParams.nPostForkSubsidyHalvingInterval;
    } else {
...
{
    RenameThread("bitcoinrandom-scriptch");
