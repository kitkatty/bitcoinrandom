...
#ifndef BITCOINRANDOM_QT_SENDCOINSDIALOG_H
#define BITCOINRANDOM_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinrandoms */
...
#endif // BITCOINRANDOM_QT_SENDCOINSDIALOG_H
