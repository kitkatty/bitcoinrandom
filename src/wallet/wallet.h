...
#ifndef BITCOINRANDOM_WALLET_WALLET_H
#define BITCOINRANDOM_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinrandom node, and set to 0 for transactions that were created
...
#endif // BITCOINRANDOM_WALLET_WALLET_H
