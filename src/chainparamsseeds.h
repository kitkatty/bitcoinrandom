#ifndef BITCOINRANDOM_CHAINPARAMSSEEDS_H
#define BITCOINRANDOM_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the bitcoinrandom network
...
#endif // BITCOINRANDOM_CHAINPARAMSSEEDS_H
