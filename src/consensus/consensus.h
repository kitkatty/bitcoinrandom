...
#ifndef BITCOINRANDOM_CONSENSUS_CONSENSUS_H
#define BITCOINRANDOM_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinRandom parameters, but if this fork is a fork
...
#endif // BITCOINRANDOM_CONSENSUS_CONSENSUS_H
