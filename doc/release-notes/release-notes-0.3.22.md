Download URL: https://sourceforge.net/projects/bitcoinrandom/files/BitcoinRandom/bitcoinrandom-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCR fee schedule (users still pay 0.01 BTCR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinrandom00 - #bitcoinrandom99
