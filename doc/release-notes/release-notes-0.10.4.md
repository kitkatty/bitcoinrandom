BitcoinRandom Core version 0.10.4 is now available from:

  <https://bitcoinrandom.org/bin/bitcoinrandom-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinrandom-tx into its own package
- #6953 `dfe0d4d` Include bitcoinrandom-tx binary on Debian/Ubuntu
