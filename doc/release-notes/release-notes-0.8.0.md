BitcoinRandom-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinrandom/files/BitcoinRandom/bitcoinrandom-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinRandom
...
New/changed settings (command-line or bitcoinrandom.conf file)
--------------------------------------------------------
