BitcoinRandom Core version 0.13.2 is now available from:

  <https://bitcoinrandom.org/bin/bitcoinrandom-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinrandom-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinrandom-tx to create v2 transactions (btcdrak)
