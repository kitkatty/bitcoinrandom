BitcoinRandom Core version *0.15.0.1* is now available from:

  <https://bitcoinrandom.org/bin/bitcoinrandom-core-0.15.0.1/>

and

  <https://bitcoinrandomcore.org/bin/bitcoinrandom-core-0.15.0.1/>
