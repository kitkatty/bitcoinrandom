BitcoinRandom Core version 0.14.2 is now available from:

  <https://bitcoinrandom.org/bin/bitcoinrandom-core-0.14.2/>
...
(in BitcoinRandom Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in BitcoinRandom-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcoinrandom-config.h as necessary (theuni)
