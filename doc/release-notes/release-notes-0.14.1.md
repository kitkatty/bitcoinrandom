BitcoinRandom Core version 0.14.1 is now available from:

  <https://bitcoinrandom.org/bin/bitcoinrandom-core-0.14.1/>
...
here:
[reducing-bitcoinrandomd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` bitcoinrandom-tx input verification (awemany, jnewbery)
