BitcoinRandom Core version 0.10.3 is now available from:

  <https://bitcoinrandom.org/bin/bitcoinrandom-core-0.10.3/>
...
(see https://github.com/bitcoinrandom/bitcoinrandom/pull/6793, as well as the 0.11.0
