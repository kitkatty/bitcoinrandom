BitcoinRandom version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinrandom/files/BitcoinRandom/bitcoinrandom-0.5.4/
...
http://gitorious.org/bitcoinrandom/bitcoinrandomd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinRandom-Qt notifications under Growl 1.3.
Increase required age of BitcoinRandom-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinRandom properly when installing BitcoinRandom-Qt over it. (Windows)
