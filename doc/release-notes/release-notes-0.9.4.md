BitcoinRandom Core version 0.9.4 is now available from:

  https://bitcoinrandom.org/bin/0.9.4/
...
this update is incompatible with the BitcoinRandom system and could lead to consensus
forks.

BitcoinRandom Core released binaries from https://bitcoinrandom.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinrandom/+archive/ubuntu/bitcoinrandom
- A third-party or self-compiled BitcoinRandom Core

upgrade to BitcoinRandom Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
