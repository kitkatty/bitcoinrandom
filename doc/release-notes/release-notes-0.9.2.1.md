BitcoinRandom Core version 0.9.2.1 is now available from:

  https://bitcoinrandom.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCR to 0.01 BTCR
...
- Fix "Start bitcoinrandom on system login"
