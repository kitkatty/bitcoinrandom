...
This document provides guidelines for internationalization of the BitcoinRandom Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinrandom_en.ts` remains unchanged.
