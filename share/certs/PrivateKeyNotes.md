...
unlocked to sign the BitcoinRandom-Qt.app bundle.
...
allowing somebody to distribute a BitcoinRandom-Qt.app or bitcoinrandom-qt-setup.exe with a valid
...
that the bitcoinrandom-qt.exe file inside the installer had not been tampered with.
